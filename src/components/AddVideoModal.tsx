          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input type="text" value={tags} onChange={(e) => setTags(e.target.value)} className="w-full px-4 py-3 border-2 border-gray-100 rounded-2xl outline-none text-sm" placeholder="누끼, AI" />
              </div>
            </div>
          </div>
