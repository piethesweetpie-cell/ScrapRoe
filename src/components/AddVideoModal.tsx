...
const AddVideoModal: React.FC<AddVideoModalProps> = ({ 
  ...
  useEffect(() => {
    if (initial) {
      ...
      setThumbnailUrl(initial.thumbnailUrl || ''); setCategory(initial.category || '');
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-4 items-center">
                <div className="w-16 h-16 bg-gray-100 rounded-2xl overflow-hidden border-2 border-gray-100 flex-shrink-0">
                  {thumbnailUrl ? (
